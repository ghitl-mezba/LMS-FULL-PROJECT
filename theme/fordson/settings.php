...
if ($ADMIN->fulltree) {
    ...
    require('settings/faq_settings.php');
    require('settings/help_desk_settings.php');
    require('settings/support_settings.php');
    require('settings/breadcrumbs_settings.php');
    require('settings/home_setting_settings.php');
    require('settings/who_we_are_settings.php');
    require('settings/what_we_do_settings.php');
    require('settings/work_with_us.php');
    require('settings/contact_message_settings.php');
    require('settings/support_message_settings.php');
    require('settings/slide_show_settings.php');
...
<style>
	...
	.alert,.continuebutton{display:none !important;}
