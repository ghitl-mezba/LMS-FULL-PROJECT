...
$templatecontext['base_url'] = "http://localhost/lms";
//$templatecontext['base_url'] = "https://elearner.ghitbd.com/lms";
$templatecontext['root_url'] = $CFG->wwwroot;
$faqs =  $DB->get_records_sql('SELECT * FROM lms_faq ORDER BY id DESC LIMIT 5');
$templatecontext['home_settings'] = $DB->get_record('home_setting', []);
