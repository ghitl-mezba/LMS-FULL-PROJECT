...
' . $jitsibuttontext . ' </span></a>';
    ...
    */
	...
	public function office_time() {
        $theme = theme_config::load('fordson');
        $setting = $theme->settings->office_time;
        return $setting != '' ? $setting : '';
    }
	public function office_address() {
        $theme = theme_config::load('fordson');
        $setting = $theme->settings->office_address;
        return $setting != '' ? $setting : '';
    }
	
	public function tag_line() {
        $theme = theme_config::load('fordson');
        $setting = $theme->settings->tag_line;
        return $setting != '' ? $setting : '';
    }
 ...
 public function facebook_footer()
    {
        $theme = theme_config::load('fordson');
    ...
    public function twitter_footer()
    {
        $theme = theme_config::load('fordson');
    ...
    public function skype_footer()
    {
        $theme = theme_config::load('fordson');
        $setting = $theme->settings->skype;
        return $setting != '' ? $setting : '';
    }
